...
{
  public:
  SetLanguageService(const std::string& name,
  ...
  void callback(const std::shared_ptr<naoqi_bridge_msgs::srv::SetString::Request> req,
  ...
  rclcpp::Service<naoqi_bridge_msgs::srv::SetString>::SharedPtr service_;
};
