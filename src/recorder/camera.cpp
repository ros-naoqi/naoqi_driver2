...
CameraRecorder::CameraRecorder(const std::string& topic_, float buffer_frequency)
    : buffer_frequency_(buffer_frequency),
      buffer_duration_(helpers::recorder::bufferDefaultDuration), counter_(1)
{
  topic_info_ = topic_ + "/camera_info";
  topic_img_ = topic_ + "/image_raw";
}

void CameraRecorder::write(const sensor_msgs::msg::Image::SharedPtr& img,
...
void CameraRecorder::writeDump(const rclcpp::Time& time)
{
  ...
  boost::circular_buffer<
      std::pair<sensor_msgs::msg::Image::SharedPtr, sensor_msgs::msg::CameraInfo>>::iterator it;
...
void CameraRecorder::bufferize(const sensor_msgs::msg::Image::SharedPtr& img,
                               const sensor_msgs::msg::CameraInfo& camera_info)
{
