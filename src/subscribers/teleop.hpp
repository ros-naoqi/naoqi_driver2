...
public:
  ...
  void joint_angles_callback( const naoqi_bridge_msgs::msg::JointAnglesWithSpeedConstPtr& js_msg );
...
private:
  ...
  rclcpp::Subscription sub_cmd_vel_;
  rclcpp::Subscription sub_joint_angles_;
