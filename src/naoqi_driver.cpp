...
std::string Driver::minidumpConverters(const std::string& prefix,
                                     ...
                                     const dataType::DataType& type)
{
  ...
  try
    ...
    {
      std::cout << BOLDRED
                << "Could not get data in memory for the key: " << BOLDCYAN
                << key << RESETCOLOR << std::endl;
      return false;
    }
...
void Driver::registerDefaultConverter()
{
  ...
  /*
   * The info converter will be called once after it was added to the priority
   * queue. Once it is its turn to be called, its callAll method will be
   * triggered (because InfoPublisher is considered to always have subscribers,
   * isSubscribed always return true). A message is therefore published through
   * InfoPublisher, even if there is nobody to receive it. Then, InfoConverter
   * will never be called again, because of its 0Hz frequency. But if a new user
   * subscribes to the "info" topic, he/she will receive the information
   * published before, as the publisher is latched.
   */
  /** Info publisher **/
  if (info_enabled)
    {
  ...
  if (imu_torso_enabled)
    {
      boost::shared_ptr<publisher::BasicPublisher<sensor_msgs::msg::Imu>>
          imutp = boost::make_shared<
              publisher::BasicPublisher<sensor_msgs::msg::Imu>>("imu/torso");
      ...
      imutc->registerCallback(
          message_actions::PUBLISH,
          boost::bind(
              &publisher::BasicPublisher<sensor_msgs::msg::Imu>::publish, imutp,
              ph::_1));
      imutc->registerCallback(
          message_actions::RECORD,
      ...
      imutc->registerCallback(
          message_actions::LOG,
          boost::bind(
              &recorder::BasicRecorder<sensor_msgs::msg::Imu>::bufferize, imutr,
              ph::_1));
      ...
      if (imu_base_enabled)
        {
          ...
          boost::shared_ptr<recorder::BasicRecorder<sensor_msgs::msg::Imu>>
              imubr = boost::make_shared<
                  recorder::BasicRecorder<sensor_msgs::msg::Imu>>("imu/base");
          ...
          imubc->registerCallback(
              message_actions::PUBLISH,
              boost::bind(
                  &publisher::BasicPublisher<sensor_msgs::msg::Imu>::publish,
                  imubp, ph::_1));
          imubc->registerCallback(
              message_actions::RECORD,
              boost::bind(
                  &recorder::BasicRecorder<sensor_msgs::msg::Imu>::write, imubr,
                  ph::_1));
          imubc->registerCallback(
              message_actions::LOG,
              boost::bind(
                  &recorder::BasicRecorder<sensor_msgs::msg::Imu>::bufferize,
                  imubr, ph::_1));
  ...
  if (camera_bottom_enabled)
    {
      ...
      boost::shared_ptr<converter::CameraConverter> bcc =
          boost::make_shared<converter::CameraConverter>(
              "bottom_camera", camera_bottom_fps, sessionPtr_,
              AL::kBottomCamera, camera_bottom_resolution);
      ...
      if (camera_depth_enabled)
        {
          ...
          boost::shared_ptr<converter::CameraConverter> dcc =
              boost::make_shared<converter::CameraConverter>(
                  "depth_camera", camera_depth_fps, sessionPtr_,
                  AL::kDepthCamera, camera_depth_resolution, this->has_stereo);

          dcc->registerCallback(
              message_actions::PUBLISH,
              boost::bind(&publisher::CameraPublisher::publish, dcp, ph::_1,
                          ph::_2));
          dcc->registerCallback(message_actions::RECORD,
                                boost::bind(&recorder::CameraRecorder::write,
                                            dcr, ph::_1, ph::_2));
          dcc->registerCallback(
              message_actions::LOG,
              boost::bind(&recorder::CameraRecorder::bufferize, dcr, ph::_1,
                          ph::_2));
      ...
      if (this->has_stereo && camera_stereo_enabled)
        {
          ...
          scc->registerCallback(
              message_actions::PUBLISH,
              boost::bind(&publisher::CameraPublisher::publish, scp, ph::_1,
                          ph::_2));
          ...
          scc->registerCallback(
              message_actions::LOG,
              boost::bind(&recorder::CameraRecorder::bufferize, scr, ph::_1,
                          ph::_2));
      ...
      if (camera_ir_enabled)
        {
          ...
          boost::shared_ptr<recorder::CameraRecorder> icr =
              boost::make_shared<recorder::CameraRecorder>(
                  "camera/ir", camera_ir_recorder_fps);
          ...
          icc->registerCallback(
              message_actions::PUBLISH,
              boost::bind(&publisher::CameraPublisher::publish, icp, ph::_1,
                          ph::_2));
          ...
          icc->registerCallback(
              message_actions::LOG,
              boost::bind(&recorder::CameraRecorder::bufferize, icr, ph::_1,
                          ph::_2));
  ...
  if (joint_states_enabled)
    {
      ...
      jsc->registerCallback(
          message_actions::PUBLISH,
          boost::bind(&publisher::JointStatePublisher::publish, jsp, ph::_1,
                      ph::_2));
      jsc->registerCallback(message_actions::RECORD,
                            boost::bind(&recorder::JointStateRecorder::write,
                                        jsr, ph::_1, ph::_2));
      jsc->registerCallback(
          message_actions::LOG,
          boost::bind(&recorder::JointStateRecorder::bufferize, jsr, ph::_1,
                      ph::_2));
  ...
  if (robot_ == robot::PEPPER)
    {
      ...
      if (laser_enabled)
        {
          boost::shared_ptr<
              publisher::BasicPublisher<sensor_msgs::msg::LaserScan>>
              lp = boost::make_shared<
                  publisher::BasicPublisher<sensor_msgs::msg::LaserScan>>(
                  "laser");
          boost::shared_ptr<
              recorder::BasicRecorder<sensor_msgs::msg::LaserScan>>
          ...
          lc->registerCallback(
              message_actions::PUBLISH,
              boost::bind(&publisher::BasicPublisher<
                              sensor_msgs::msg::LaserScan>::publish,
                          lp, ph::_1));
          lc->registerCallback(
              message_actions::RECORD,
              boost::bind(
                  &recorder::BasicRecorder<sensor_msgs::msg::LaserScan>::write,
                  lr, ph::_1));
          lc->registerCallback(
              message_actions::LOG,
              boost::bind(&recorder::BasicRecorder<
                              sensor_msgs::msg::LaserScan>::bufferize,
                          lr, ph::_1));
  ...
  if (sonar_enabled)
    {
      ...
      boost::shared_ptr<converter::SonarConverter> usc =
          boost::make_shared<converter::SonarConverter>(
              "sonar", sonar_frequency, sessionPtr_);
  ...
  if (hand_enabled)
    {
      ...
      boost::shared_ptr<HandTouchEventRegister> event_register =
          boost::make_shared<HandTouchEventRegister>(
              "hand_touch", hand_touch_events, 0, sessionPtr_, naoqi_version);
  ...
  if (head_enabled)
    {
      ...
      boost::shared_ptr<HeadTouchEventRegister> event_register =
          boost::make_shared<HeadTouchEventRegister>(
              "head_touch", head_touch_events, 0, sessionPtr_, naoqi_version);
  ...
  if (odom_enabled)
    {
      boost::shared_ptr<publisher::BasicPublisher<nav_msgs::msg::Odometry>> lp =
          boost::make_shared<
              publisher::BasicPublisher<nav_msgs::msg::Odometry>>("odom");
...
{
  registerService(boost::make_shared<service::RobotConfigService>(
      "get_robot_config", "/naoqi_driver/get_robot_config", sessionPtr_));
  registerService(boost::make_shared<service::SetLanguageService>(
      "set_language", "/naoqi_driver/set_language", sessionPtr_));
  registerService(boost::make_shared<service::GetLanguageService>(
      "get_language", "/naoqi_driver/get_language", sessionPtr_));
}
...
void Driver::addMemoryConverters(std::string filepath)
{
  ...
  try
    ...
    {
      std::cout << "\"frequency\" could not be interpreted as float: "
                << e.what() << std::endl;
      ...
      case 0:
        ...
        case 1: {
          boost::shared_ptr<EventRegister<
              ...
              recorder::BasicEventRecorder<
                  naoqi_bridge_msgs::msg::FloatStamped>>>
        ...
        case 3: {
          boost::shared_ptr<EventRegister<
              ...
              publisher::BasicPublisher<naoqi_bridge_msgs::msg::StringStamped>,
              recorder::BasicEventRecorder<
                  naoqi_bridge_msgs::msg::StringStamped>>>
              event_register = boost::make_shared<
        ...
        case 4: {
          boost::shared_ptr<EventRegister<
              ...
              publisher::BasicPublisher<naoqi_bridge_msgs::msg::BoolStamped>,
              recorder::BasicEventRecorder<
                  naoqi_bridge_msgs::msg::BoolStamped>>>
              event_register = boost::make_shared<
...
QI_REGISTER_OBJECT(Driver, _whoIsYourDaddy, minidump, minidumpConverters,
                   setBufferDuration, getBufferDuration, startPublishing,
                   stopPublishing, getAvailableConverters,
                   getSubscribedPublishers, addMemoryConverters,
                   registerMemoryConverter, registerEventConverter,
                   getFilesList, removeAllFiles, removeFiles, startRecording,
                   startRecordingConverters, stopRecording, startLogging,
                   stopLogging);
}  // namespace naoqi
